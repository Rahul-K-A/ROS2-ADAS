...
class Control():
    def __init__(self):
        ...
        self.TL_Detector=TLDetection("/home/rahul/ROS2-AMR/self_driving_car_pkg/self_driving_car_pkg/Data/light_best.pt")
    ...
    def OBEY_TrafficLights(self,Traffic_State,CloseProximity):
        ...
        if((Traffic_State == "red") and CloseProximity):
            print("Case1")
            ...
            if (self.STOP_MODE_ACTIVATED or self.GO_MODE_ACTIVATED):
                ...
                if (self.STOP_MODE_ACTIVATED and (Traffic_State=="green")):
                    print("Case 2")
                    self.STOP_MODE_ACTIVATED = False
    ...
    def drive(self,Current_State):
        ...
        print(traffic_state,proximity_status, self.STOP_MODE_ACTIVATED,self.GO_MODE_ACTIVATED)
        print()
...
class Car():
    ...
    def drive_car(self,frame):
        ...
        traffic_state,proximity_status =  self.Control.TL_Detector.detect(frame.copy())
